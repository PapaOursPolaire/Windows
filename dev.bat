...
echo.
echo ================================================================
echo                SCRIPT D'INSTALLATION LOGICIELS WINDOWS 11
echo                     Developpement, Multimedia et Utilitaires
echo ================================================================
echo.
...
if %errorLevel% neq 0 (
    ...
    powershell -Command "& { $progressPreference = 'silentlyContinue'; $latestWingetMsixBundleUri = (Invoke-RestMethod https://api.github.com/repos/microsoft/winget-cli/releases/latest).assets | Where-Object { $_.browser_download_url.EndsWith('.msixbundle') } | Select-Object -First 1; $latestWingetMsixBundle = $latestWingetMsixBundleUri.browser_download_url.Split('/')[-1]; Write-Host 'Telechargement du dernier package Microsoft.VCLibs.x64.14.00.Desktop...'; Invoke-WebRequest -Uri https://aka.ms/Microsoft.VCLibs.x64.14.00.Desktop.appx -OutFile Microsoft.VCLibs.x64.14.00.Desktop.appx; Write-Host 'Telechargement du dernier package Microsoft.UI.Xaml.2.8...'; Invoke-WebRequest -Uri https://github.com/microsoft/microsoft-ui-xaml/releases/download/v2.8.6/Microsoft.UI.Xaml.2.8.x64.appx -OutFile Microsoft.UI.Xaml.2.8.x64.appx; Write-Host 'Telechargement du dernier Winget...'; Invoke-WebRequest -Uri $latestWingetMsixBundleUri.browser_download_url -OutFile $latestWingetMsixBundle; Write-Host 'Installation des dependances...'; Add-AppxPackage Microsoft.VCLibs.x64.14.00.Desktop.appx; Add-AppxPackage Microsoft.UI.Xaml.2.8.x64.appx; Write-Host 'Installation de Winget...'; Add-AppxPackage $latestWingetMsixBundle; Write-Host 'Nettoyage des fichiers temporaires...'; Remove-Item Microsoft.VCLibs.x64.14.00.Desktop.appx; Remove-Item Microsoft.UI.Xaml.2.8.x64.appx; Remove-Item $latestWingetMsixBundle }"
...
echo.
echo OUTILS DE DEVELOPPEMENT - Git, editeurs, langages, bases de donnees
...
echo.
echo PRISE DE NOTES - Applications pour organiser ses notes et idees
...
echo.
echo BUREAU ET UTILITAIRES SYSTEME - Outils pour optimiser et personnaliser Windows
...
echo.
echo INTERNET ET COMMUNICATION - Navigateurs et apps de messagerie
...
echo.
echo Plateformes de jeux et outils gaming
...
echo.
echo Gestionnaires de mots de passe et outils de securite
...
echo.
echo Divers et utilitaires systeme
...
echo.
echo Outils d'Intelligence Artificielle
...
echo.
echo Extensions VS Code recommandees
